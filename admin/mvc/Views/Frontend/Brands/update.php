...
<body>
            ...
            <form action="" method="POST">
                <div class="page_header">
                    <div class="container_fluid d_flex justify_content_between align_items_center">
                        ...
                        <div class="d_flex align_items_center">
                            <button type="submit" <?php echo empty($brandItem) ? "disabled" : ''; ?> class="btn_item btn_primary" name="updateBrand_action">
                                <i class="fa fa-save" aria-hidden="true"></i>
                                <span>Cập nhật</span>
                            </button>
                            <a class="btn_item btn_default" href="<?php {{ echo Config::getBaseUrlAdmin("?controller=Brand"); }} ?>">
                ...
                <div class="table_content container_fluid">
                    <div class="panel_table">
                        ...
                        <?php {{ view("Inc.notification_status_form", [ "dataStatusBrand" => !empty($dataStatusBrand) ? $dataStatusBrand : null ]); }} ?>
                        <div class="panel_body">
                                        ...
                                        <div class="tab_pane" id="tab_general">
                                            <div class="form_group status_wrap d_flex align_items_center">
                                                ...
                                                <div class="switch_status">
                                                    <label for="status_value" class="status_toggle">
                                                        <input type="checkbox" <?php {{
                                                            if( !empty(Validation::form_value("brand_is_status")) ) {
                                                                echo Validation::form_value("brand_is_status") == "on" ? "checked" : null;
                                                            } else {
                                                                echo $brandItem['brand_is_status'] == "on" ? "checked" : null;
                                                            }
                                                        }} ?> name="brand_is_status" id="status_value" class="d_none">
                                            ...
                                            <div class="content_group">
                                                <div class="form_group d_flex align_items_center">
                                                    ...
                                                    <div class="form_input">
                                                        <input value="<?php {{
                                                            if( !empty(Validation::form_value("brand_name")) ) {
                                                                echo Validation::form_value("brand_name");
                                                            } else {
                                                                echo $brandItem['brand_name'];
                                                            }
                                                        }} ?>" class="form_control" type="text" name="brand_name" id="brand_name" placeholder="Tên thương hiệu" autocomplete="off" spellcheck="false">
                                                        <?php {{ echo Validation::form_error("brand_name"); }} ?>
                                                    </div>
                                                </div>
                                                <div class="form_group d_flex align_items_center">
                                                    ...
                                                    <div class="form_input position_relative">
                                                        <label for="prod_avatar">
                                                            <span class="thumbNail small">
                                                                <img id="brand_logo_append" class="img_cover full_size" src="<?php {{
                                                                    if( !empty(Validation::form_value("brand_logo")) ) {
                                                                        echo Validation::form_value("brand_logo");
                                                                    } else {
                                                                        echo !empty($brandItem['brand_logo']) ? $brandItem['brand_logo'] : "./public/images/logo/no_image-50x50.png";
                                                                    }
                                                                }} ?>">
                                                            </span>
                                                            <div class="popover position_absolute" style="left: 155px;">
                                                                <div class="popover_content d_flex align_items_center">
                                                                    <label for="brand_logo_fake" style="padding: 6px 10px 7px 12px;margin-right: 3px;" class="button_image btn btn_primary iframe-btn">
                                                                        <i class="fa fa-pencil"></i>
                                                                        <input value="<?php {{
                                                                            if( !empty(Validation::form_value("brand_logo_fake")) ) {
                                                                                echo Validation::form_value("brand_logo_fake");
                                                                            } else {
                                                                                echo $brandItem['brand_logo'];
                                                                            }
                                                                        }} ?>" type="file" class="d_none" id="brand_logo_fake">
                                                                        <input value="<?php {{
                                                                            if( !empty(Validation::form_value("brand_logo")) ) {
                                                                                echo Validation::form_value("brand_logo");
                                                                            } else {
                                                                        ...
                                                                        }} ?>" type="hidden" class="d_none" name="brand_logo" id="brand_logo">
                                                                    </label>
                                                        ...
                                                        <?php echo Validation::form_error("brand_logo"); ?>
                                                        <p class="_brand_upload_logo_error_ success " style="color: green; font-size:.9rem; margin:14px 0 0 20px;"></p>
                                                    </div>
                                                </div>
                                                <div class="form_group d_flex align_items_center">
                                                    <label for="brand_order" class="form_label">Số TT MAX</label>
                                                    <div class="form_input">
                                                        <input disabled style="width: 100px; text-align: center;" class="hidden_input_number form_control order_max" type="number" min="1" name="brand_order">
                                                    </div>
                                                </div>
                                                <div class="form_group d_flex align_items_center">
                                                    ...
                                                    <div class="form_input">
                                                        <input value="<?php {{
                                                            if( !empty(Validation::form_value("brand_order")) ) {
                                                                echo Validation::form_value("brand_order");
                                                            } else {
                                                                echo $brandItem['brand_order'];
                                                            }
                                                        }} ?>" class="form_control" type="number" min="1" name="brand_order" id="brand_order" placeholder="Thứ tự hiển thị" autocomplete="off" spellcheck="false">
                                                    </div>
                                                </div>
                                                <div class="form_group d_flex align_items_center">
                                                    ...
                                                    <div class="form_input">
                                                        <input value="<?php {{
                                                            if( !empty(Validation::form_value("brand_meta_keywords")) ) {
                                                                echo Validation::form_value("brand_meta_keywords");
                                                            } else {
                                                                echo $brandItem['brand_meta_keywords'];
                                                            }
                                                        }} ?>" class="form_control" type="text" name="brand_meta_keywords" id="brand_meta_keywords" placeholder="Từ khóa" autocomplete="off" spellcheck="false">
                                                        <?php {{ echo Validation::form_error("brand_meta_keywords"); }}?>
                                                    </div>
                                                </div>
                                                <div class="form_group d_flex align_items_center">
                                                    ...
                                                    <div class="form_input">
                                                        <input value="<?php {{
                                                            if( !empty(Validation::form_value("brand_meta_title")) ) {
                                                                echo Validation::form_value("brand_meta_title");
                                                            } else {
                                                                echo $brandItem['brand_meta_title'];
                                                            }
                                                        }} ?>" class="form_control" type="text" name="brand_meta_title" id="brand_meta_title" placeholder="Thẻ tiêu đề (Meta title)" autocomplete="off" spellcheck="false">
                                                        <?php {{ echo Validation::form_error("brand_meta_title"); }} ?>
                                                    </div>
                                                </div>
                                                <div class="form_group d_flex align_items_center">
                                                    <label for="brand_meta_desc" class="form_label"><strong style="color: #f00;">*</strong> Thẻ mô tả (Meta desc)</label>
                                                    <div class="form_input">
                                                        <textarea class="form_control" name="brand_meta_desc" id="brand_meta_desc" placeholder="Thẻ mô tả (Meta desc)" spellcheck="false"><?php {{
                                                            if( !empty(Validation::form_value("brand_meta_desc")) ) {
                                                                echo Validation::form_value("brand_meta_desc");
                                                            } else {
                                                                echo $brandItem['brand_meta_desc'];
                                                            }
                                                        }} ?></textarea>
                                                        <?php {{ echo Validation::form_error("brand_meta_desc"); }} ?>
                                                    </div>
                                                </div>
                                                <div class="form_group d_flex align_items_center">
                                                    ...
                                                    <div class="form_input">
                                                        ...
                                                        <div class="google_url"><?php {{
                                                            ...
                                                            <span class="default">https://thachcellphones.vn/</span><span class="url"><?php {{
                                                                if( !empty(Validation::form_value("brand_meta_url")) ) {
                                                                    echo Validation::form_value("brand_meta_url");
                                                                } else {
                                                                    echo $brandItem['brand_meta_url'];
                                                                }
                                                            }} ?></span>
                                                        </div>
                                                ...
                                                <div class="form_group seoUrl d_flex align_items_center">
                                                    ...
                                                    <div class="form_input">
                                                        <input class="form_control" type="text" id="brand_meta_url" value="<?php {{
                                                            if( !empty(Validation::form_value("brand_meta_url")) ) {
                                                                 echo Validation::form_value("brand_meta_url");
                                                            } else {
                                                                echo $brandItem['brand_meta_url'];
                                                        ...
                                                        <input type="hidden" name="brand_meta_url" value="<?php {{
                                                            if( !empty(Validation::form_value("brand_meta_url")) ) {
                                                                 echo Validation::form_value("brand_meta_url");
                                                            } else {
                                                                echo $brandItem['brand_meta_url'];
                                                        ...
                                                        <?php {{ echo Validation::form_error("brand_meta_url"); }} ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <?php else : ?>
                                <p class="data-empty">Không tồn tại thương hiệu này !</p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript" src="./public/js/app/brand.add.ajax.js"></script>
