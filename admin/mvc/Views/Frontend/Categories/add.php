                                            ...
                                            <div class="form_group d_flex align_items_center">
                                                ...
                                                <div class="form_input">
                                                    ...
                                                    <div class="google_url">
                                                        ...
                                                        <span class="url"><?php {{echo Validation::form_value("cateprod_meta_url"); }} ?></span>
                                                    </div>
                                                ...
                                                <label for="cateprod_icon">
                                                    <span class="thumbNail small">
                                                        <img class="img_cover full_size" id="cateprod_icon_append" src="<?php {{
                                                            echo !empty(Validation::form_value("cateprod_icon")) ? Validation::form_value("cateprod_icon") : "./public/images/logo/no_image-50x50.png";
                                                        }} ?>" alt="">
                                                    </span>
                                                    <div class="popover position_absolute" style="left: 155px;">
                                                        <div class="popover_content d_flex align_items_center">
                                                            <label for="cateprod_icon_fake" style="padding: 6px 10px 7px 12px;margin-right: 3px;" class="button_image btn btn_primary iframe-btn">
                                                                <i class="fa fa-pencil"></i>
                                                                <input type="file" class="d_none" id="cateprod_icon_fake" value=" <?php {{ echo Validation::form_value("cateprod_icon_fake"); }} ?>">
                                                                <input type="hidden" class="d_none" name="cateprod_icon" id="cateprod_icon" value="<?php {{echo Validation::form_value("cateprod_icon");}} ?>">
                                                            </label>
                                                ...
                                                <label for="cateprod_banner_pc">
                                                    <span class="thumbNail banner __PC">
                                                        <img id="cateprod_banner_pc_append" src="<?php {{
                                                            echo !empty(Validation::form_value("cateprod_banner_pc")) ? Validation::form_value("cateprod_banner_pc") : "./public/images/logo/no_image-50x50.png";
                                                        ...
                                                        <div class="popover position_absolute" style="left: -104px; top:40%;">
                                                            ...
                                                            <label for="cateprod_banner_pc_fake" style="padding: 6px 10px 7px 12px;margin-right: 3px;" class="button_image btn btn_primary iframe-btn">
                                                                <i class="fa fa-pencil"></i>
                                                                <input type="file" class="d_none" id="cateprod_banner_pc_fake" value="<?php {{ echo Validation::form_value("cateprod_banner_mb_fake"); }} ?>">
                                                                <input type="hidden" class="d_none" name="cateprod_banner_pc" id="cateprod_banner_pc" value="<?php {{echo Validation::form_value("cateprod_banner_pc");}} ?>">
                                                            </label>
