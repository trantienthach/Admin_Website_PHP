                                    ...
                                    <div class="tab_pane" id="tab_general">
                                        ...
                                        <div class="content_group">
                                            ...
                                            <div class="form_group d_flex align_items_center">
                                                ...
                                                <div class="form_input">
                                                    <textarea class="form_control ckeditor" name="prod_short_desc" id="prod_short_desc" placeholder="Mô tả ngắn" spellcheck="false"><?php {{ echo Validation::form_value("prod_short_desc");}} ?></textarea>
                                            ...
                                            <div class="form_group d_flex align_items_center">
                                                ...
                                                <div class="form_input">
                                                    <textarea class="form_control ckeditor" name="prod_content_main_desc" id="prod_content_main_desc" placeholder="Mô tả chi tiết" spellcheck="false"><?php {{ echo Validation::form_value("prod_content_main_desc");}} ?></textarea>
                                            ...
                                            <div class="form_group d_flex align_items_center">
                                                ...
                                                <div class="form_input">
                                                    <div class="google_title">Cellphones <?php {{ echo Validation::form_value("prod_meta_title");}} ?></div>
                                                    <div class="google_url">
                                                        <span class="default">Cellphones.com/<?php {{ echo Validation::form_value("prod_meta_seourl");}} ?></span>
                                                        <span class="url"></span>
                                                    </div>
                                                    <div class="google_desc"><?php {{ echo Validation::form_value("prod_meta_desc");}} ?></div>
                                                </div>
                                            </div>
                                            <div class="form_group seoUrl d_flex align_items_center">
                                                ...
                                                <div class="form_input">
                                                    <input class="form_control" type="text" id="prod_meta_seourl" value="<?php {{ echo Validation::form_value("prod_meta_seourl"); }} ?>" placeholder="Đường dẫn SEO" autocomplete="off" spellcheck="false">
                                                    <input type="hidden" name="prod_meta_seourl" value="<?php {{ echo Validation::form_value("prod_meta_seourl"); }} ?>">
                                                ...
                                                <label for="prod_avatar">
                                                    <span class="thumbNail small">
                                                        <img class="img_cover full_size" id="prod_avatar_append" src="<?php {{
                                                            echo !empty(Validation::form_value("prod_avatar")) ? Validation::form_value("prod_avatar") : "./public/images/logo/no_image-50x50.png";
                                                        }} ?>" alt="">
                                                    </span>
                                                    <div class="popover position_absolute" style="left: 155px;">
                                                        <div class="popover_content d_flex align_items_center">
                                                            <label for="prod_avatar_fake" style="padding: 6px 10px 7px 12px;margin-right: 3px;" class="button_image btn btn_primary iframe-btn">
                                                                <i class="fa fa-pencil"></i>
                                                                <input type="file" class="d_none" id="prod_avatar_fake" value=" <?php {{ echo Validation::form_value("prod_avatar_fake"); }} ?>">
                                                                <input type="hidden" class="d_none" name="prod_avatar" id="prod_avatar" value="<?php {{echo Validation::form_value("prod_avatar");}} ?>">
                                                            </label>
